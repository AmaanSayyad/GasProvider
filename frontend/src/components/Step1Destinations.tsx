...
import { Search, Settings2, ChevronDown, ChevronUp, Wallet, AlertCircle, ChevronRight, Calendar, FolderOpen } from "lucide-react";
            ...
            >
              <div className="flex items-center gap-3">
                <img
                  ...
                  alt="chain"
                  className="w-10 h-10 rounded-full bg-theme-muted p-0.5 shadow-md group-hover:scale-110 transition-transform"
                />
              ...
              <div className="flex items-center gap-2">
                {sourceToken && (
                  <div className="text-right mr-2">
                    <div className="text-sm font-bold text-theme">{sourceToken.balance}</div>
